...
{
    public partial class OldStudentForm : Form
    {
        public OldStudentForm()
        {
            InitializeComponent();
        }
        ...
        private void OldStudentForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void OSFormClosed(object sender, FormClosedEventArgs e)
        {
